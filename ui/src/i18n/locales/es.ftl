...
download-all-hint = Descarga todas las apps disponibles para este equipo.
download-all-unsupported = «Descargar todo» requiere la app de escritorio Freally Central.
download-all-none = Aún no hay apps para descargar.
language = Idioma
