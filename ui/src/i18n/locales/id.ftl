...
download-all-hint = Mengunduh semua aplikasi yang tersedia untuk komputer ini.
download-all-unsupported = "Unduh Semua" memerlukan aplikasi desktop Freally Central.
download-all-none = Belum ada aplikasi yang dapat diunduh.
language = Bahasa
