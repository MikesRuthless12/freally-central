...
download-all-hint = Завантажує всі доступні застосунки для цього комп’ютера.
download-all-unsupported = «Завантажити все» потребує настільного застосунку Freally Central.
download-all-none = Поки немає застосунків для завантаження.
language = Мова
