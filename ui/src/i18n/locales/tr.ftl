...
download-all-hint = Bu bilgisayar için mevcut tüm uygulamaları indirir.
download-all-unsupported = "Tümünü indir" Freally Central masaüstü uygulamasını gerektirir.
download-all-none = Henüz indirilebilir uygulama yok.
language = Dil
