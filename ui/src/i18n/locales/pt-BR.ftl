...
download-all-hint = Baixa todos os apps disponíveis para este computador.
download-all-unsupported = “Baixar tudo” requer o app de desktop Freally Central.
download-all-none = Ainda não há apps para baixar.
language = Idioma
