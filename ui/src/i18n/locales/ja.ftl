...
download-all-hint = このコンピューター向けの利用可能なアプリをすべてダウンロードします。
download-all-unsupported = 「すべてダウンロード」には Freally Central デスクトップアプリが必要です。
download-all-none = ダウンロード可能なアプリはまだありません。
language = 言語
