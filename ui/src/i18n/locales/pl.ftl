...
download-all-hint = Pobiera wszystkie dostępne aplikacje na ten komputer.
download-all-unsupported = „Pobierz wszystko” wymaga aplikacji desktopowej Freally Central.
download-all-none = Brak aplikacji do pobrania.
language = Język
