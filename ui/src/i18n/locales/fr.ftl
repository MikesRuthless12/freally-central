...
download-all-hint = Télécharge toutes les apps disponibles pour cet ordinateur.
download-all-unsupported = « Tout télécharger » nécessite l’app de bureau Freally Central.
download-all-none = Aucune app téléchargeable pour l’instant.
language = Langue
