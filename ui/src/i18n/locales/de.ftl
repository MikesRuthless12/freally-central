...
download-all-hint = Lädt jede verfügbare App für diesen Computer herunter.
download-all-unsupported = „Alle herunterladen“ erfordert die Freally-Central-Desktop-App.
download-all-none = Noch keine herunterladbaren Apps.
language = Sprache
