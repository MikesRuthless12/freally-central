...
available = Доступные
coming-soon = Скоро
install-all = Скачать и установить все
install-all-hint = Скачивает и тихо устанавливает все доступные приложения для этого компьютера.
install-all-unsupported = Для установки нужно настольное приложение Freally Central.
install-all-none = Пока нет приложений для скачивания.
language = Язык
...
dl-installing = Установка…
install-progress-label = Ход установки { $name }
install-done = Установлено ✓
install-canceled = Установка отменена.
install-failed = Установка не удалась.
install-failed-not-downloaded = Сначала скачайте приложение, чтобы установить его.
install-failed-not-verified = Этот установщик не проверен для тихой установки — он не был запущен.
install-failed-verify = Проверка не пройдена — установщик отклонён.
install-failed-unsupported = Установщик этого типа нельзя тихо установить на этом компьютере.
install-failed-installer = Установщик сообщил об ошибке.
install-failed-elevation = В правах администратора отказано.
install-failed-busy = Установка уже выполняется.
open-app = Открыть
open-failed = Не удалось открыть { $name }.
batch-installing = Установка… установлено { $done } из { $total }
batch-installed = Все приложения установлены.
batch-install-failed = Не удалось { $failed } из { $total } установок.
batch-install-canceled = Отменено { $canceled } из { $total } установок.
